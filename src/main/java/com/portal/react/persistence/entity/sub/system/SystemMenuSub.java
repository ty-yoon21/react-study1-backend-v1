...
@Table(name = "T_SYS_MENU"
        , indexes = {
        @Index(name = "T_CM_MENU_IDX_01", unique = false, columnList = "system_cd"),
        @Index(name = "T_CM_MENU_IDX_02", unique = false, columnList = "menu_cd"),
        @Index(name = "T_CM_MENU_IDX_03", unique = false, columnList = "prnt_cd"),
